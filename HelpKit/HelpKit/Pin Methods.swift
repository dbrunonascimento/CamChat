...
public extension Pinnable{
    ...
    @discardableResult func pinAllSides(addTo view: UIView? = nil, pinTo object: Pinnable) -> Pins{
        return pinAllSides(addTo: view, pinTo: object, insets: UIEdgeInsets.zero)
    }
    
    
    @discardableResult func pinAllSides(addTo view: UIView? = nil, pinTo object: Pinnable, insets: UIEdgeInsets = UIEdgeInsets.zero) -> Pins{
    ...
    @discardableResult func pin(addTo view: UIView? = nil, anchors: [ConstraintDimension: PinnableLayoutAnchor] = [:], constants: [ConstraintDimension: CGFloat] = [:], multipliers: [MultipliableConstraintDimension: CGFloat] = [:]) -> Pins {
    ...
    @discardableResult func pin(addTo view: UIView?, anchors: [ConstraintDimension: PinnableLayoutAnchor], constants: [ConstraintDimension: CGFloat]) -> Pins {
        return self.pin(addTo: view, anchors: anchors, constants: constants, multipliers: [:])
    }
    
    @discardableResult func pin(addTo view: UIView?, anchors: [ConstraintDimension: PinnableLayoutAnchor]) -> Pins {
